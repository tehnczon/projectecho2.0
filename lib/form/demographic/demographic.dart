...
import 'package:projecho/form/demographic/demog1_HIVrelation.dart';
import 'package:projecho/form/demographic/demog2_educationLevel.dart';
import 'package:projecho/form/demographic/demog3_isWorking.dart';
import 'package:projecho/form/demographic/demog4_civilStatus.dart';
import 'package:projecho/form/plhivForm/step6_confirmation.dart';

class Demographic extends StatefulWidget {
  final RegistrationData registrationData;

  const Demographic({super.key, required this.registrationData});
...
class _DemographicState extends State<Demographic>
  ...
  Widget _buildStepContent() {
    ...
    switch (_currentStep) {
      case 0:
        content = demog1HIVrelationForm(
          registrationData: widget.registrationData,
          formKey: _formKeys[0],
        );
        break;
      case 1:
        content = demog2EducationLevel(
          registrationData: widget.registrationData,
          formKey: _formKeys[1],
        );
        break;
      case 2:
        content = demog3Working(
          registrationData: widget.registrationData,
          formKey: _formKeys[2],
        );
        break;
      case 3:
        content = demog4CivilStatus(
          registrationData: widget.registrationData,
          formKey: _formKeys[3],
        );
        break;
  ...
  Future<void> _submitForm() async {
    ...
    while (retryCount < maxRetries) {
      try {
        ...
        bool success = await widget.registrationData.saveToUserDemographic();
